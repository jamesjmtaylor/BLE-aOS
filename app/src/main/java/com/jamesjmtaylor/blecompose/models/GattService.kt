...
enum class GattService(val prefix: String, val uuid: String) {
    ...
    DeviceInformation("0000180a","0000180a-0000-1000-8000-00805f9b34fb"),
    HeartRate("0000180d","0000180d-0000-1000-8000-00805f9b34fb"),
    Battery("0000180f","0000180f-0000-1000-8000-00805f9b34fb"),
    RunningSpeedAndCadence("00001814","00001814-0000-1000-8000-00805f9b34fb");
